...
def visualise_layer_filter(model, layer_nmbr, filter_nmbr, num_optim_steps=26, lr=0.1):
...
if __name__ == "__main__":
    ...
    visualise_layer_filter(model, layer_nmbr=layer_nmbr, filter_nmbr=filter_nmbr)
