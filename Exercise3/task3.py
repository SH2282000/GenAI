...
from task2 import convert_mnist_to_vectors
from task1 import Linear, Softmax, ReLU, CrossEntropyLoss
...
class MultilayerPerceptron(nn.Module):
    ...
    def __init__(self, size_hidden=100, size_out=10):
        ...
        self.fc1 = Linear(size_hidden, size_out)
        self.fc2 = Linear(size_hidden, size_out)
        self.fc3 = ReLU()
        self.fc4 = Linear(size_hidden, size_out)
